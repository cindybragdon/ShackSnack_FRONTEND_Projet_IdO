...
import { registerForPushNotificationsAsync } from '../utils/notifications'; // Importation unique de la fonction
...
const Index = () => {
    ...
    return (
        <View className={`flex-1 items-center`} style={{ backgroundColor: colors.background_w }}>
            ...
            <Text className="text-3xl font-bold underline" style={{ color: colors.black }}>
                Si vous n'avez pas de compte, <Link style={{ color: colors.orange }} href="./auth/signup">Sign-up</Link>
            </Text>
        </View>
    );
};
